                  ...
                  <div className="feature-container">
                     ...
                     <div className='feature-box'>
                        ...
                        <div className='feature-text'>
                           ...
                           <p className='feature-description'>
                           Hasil dari implementasi SPBE diharapkan dapat meningkatkan kualitas pelayanan publik, mendorong transparansi dan akuntabilitas pemerintahan, serta mengurangi tingkat penyalahgunaan kewenangan seperti korupsi, kolusi, dan nepotisme.                           </p>
                        </div>
                        <hr className="feature-line" />
                     </div>
                  </div>
